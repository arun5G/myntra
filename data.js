...
//  btn.setAttribute("src","
   ...
   nam.innerText=mensData[i].name;
price.innerText= mensData[i].price;
off.innerText="Discount "+mensData[i].strikedoffprice;
brand:"Nike",
hi.innerText=mensData[i].brand
d.append(img,nam,price,off,hi,a)
div.append(d);
// console.log(hi)
}
...
document.querySelector("#msel").addEventListener("change",koi)

function koi(){
   var d= document.querySelector("#msel").value;
...
// 88888888888888888888888888888888 sort name

document.querySelector("#mname").addEventListener("change",soi)

function soi(){
   var d= document.querySelector("#mname").value;
// console.log(11111111111111,d)
if(d=="asd"){
...
document.querySelector("#mfilter").addEventListener("change",asdf)

function asdf(){
    var tag=document.querySelector("#mfilter").value;
    
   var list= mensData.filter(function(el){
        return el.brand==tag
    })
chalu(list)
}
